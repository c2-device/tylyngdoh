...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('workGallery', () => ({
    ...
    projects: [
      ...
      { id: 5, type: 'image', category: 'Web Series', title: 'Hills on a Plate', image: 'images/poster/Hillsontheplate.webp', alt: 'Poster for the food and travel series Hills on a Plate, on JioHotstar', link: 'https://www.youtube.com/watch?v=xLOxK-xocqk' },
