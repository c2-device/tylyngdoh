...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('workGallery', () => ({
    ...
    projects: [
      ...
      { id: 4, type: 'image', category: 'Short Film', title: 'Ka Jingshemphang (The Knowing)', image: 'images/poster/Ka_Jingshemphang.png', alt: 'Poster for the short film Ka Jingshemphang (The Knowing)', link: 'https://www.youtube.com/watch?v=KA58-eTE93I' },
