...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('workGallery', () => ({
    ...
    projects: [
      { id: 1, type: 'image', category: 'Feature Film', title: 'Iewduh', image: 'images/poster/Iewduh.jpeg', alt: 'Poster for the feature film Iewduh', link: 'https://www.youtube.com/watch?v=bPXRz7ymJx4' },
      { id: 2, type: 'image', category: 'Feature Film', title: 'Lorni – The Flaneur', image: 'images/poster/Lorni_The_Flaneur.jpg', alt: 'Poster for the feature film Lorni, The Flaneur', link: 'https://www.youtube.com/watch?v=_2mQlNUGbzI' },
      ...
      { id: 4, type: 'image', category: 'Short Film', title: 'Ka Jingshemphang (The Knowing)', image: 'images/poster/Ka_Jingshemphang.jpg', alt: 'Poster for the short film Ka Jingshemphang (The Knowing)', link: 'https://www.youtube.com/watch?v=KA58-eTE93I' },
      { id: 5, type: 'image', category: 'Documentary', title: 'Hills on a Plate', image: 'images/poster/Hillsontheplate.webp', alt: 'Poster for the food and travel series Hills on a Plate, on JioHotstar', link: 'https://www.youtube.com/watch?v=xLOxK-xocqk' },
      { id: 6, type: 'image', category: 'Music Video', title: 'Shillong Chamber Choir', image: 'images/poster/ShilongChamberchoir.jpg', alt: 'Poster for a Shillong Chamber Choir music video', link: 'https://www.youtube.com/watch?v=W3osA3ho6H4' },
  ...
  Alpine.data('achievementsTimeline', () => ({
    ...
    milestones: [
      ...
      { id: 2, year: '2019', category: 'collective', tag: 'Collective', title: 'Co-Founded The Hillspeople Collective', description: 'Founded The Hillspeople Collective, a creative and production company built around film production, creative direction, production management and communications.', present: false },
